...
@section('container')
    <h2 class="font-weight-bolder mb-3 ms-3 text-center bg-su">

        {{ Request::is('rtp/posts/*') || Request::is('rtp/search/*') ? $provider : '' }}
    </h2>
    <div class="container">
        <div class="bg-rd"></div>
        <div class="bg-rd-yl"></div>

        <div class="row justify-content-center">
            <div class="col-md-10 mx-auto">

                <div class="rowsearch justify-content-center">
                    <div class="col-md-6">
                        <a href="/create/rtp/{{ $provider }}"><button
                                class="btn btn-icon btn-3 btn btn-outline-light bg-tmbh-btn my-4" type="button">
                                <span class="btn-inner--text text-large"> <i class="ni ni-fat-add"></i> Tambah Postingan
                                    Slot</span>
                                            ...
                                            @if ($post->priority > 0)
                                                <div class="form-check form-switch py-2">
                                                    <input class="form-check-input" type="checkbox" id="priority"
                                                        name="priority" checked="" disabled>
                                                </div>
                                            @else
                                                <div class="form-check form-switch py-2">
                                                    <input class="form-check-input" type="checkbox" id="priority"
