...
$pp = query("SELECT * FROM rtp_providers WHERE divisi LIKE '%pp%';");
    ...
    <div class="container">
                ...
                <table class="table" id="tablegp">
                    <tbody id="tbgame" class="icgame">
                        <tr>
                            ...
                            <td><a href="../Provider/Habanero/"><img
                                        src="../tr3xd1ath/storage/imgrtp/provider/habanero.png"></a></td>
                            <td><a href="../Provider/MicroGaming/"><img
                                        src="/tr3xd1ath/storage/imgrtp/provider/microgaming.png"></a></td>
                        </tr>
                        <tr>
                            <td><a href="../Provider/PGsoft/"><img
                                        src="/tr3xd1ath/storage/imgrtp/provider/pgsoft.png"></a></td>
                            <td><a href="../Provider/TopTrend/"><img
                                        src="/tr3xd1ath/storage/imgrtp/provider/toptrend.png"></a></td>
                            <td><a href="../Provider/IDN/"><img src="/tr3xd1ath/storage/imgrtp/provider/idnslot.png"><a
                                        href=""></a></td>
                        </tr>
                        <tr>
                            <td colspan="3"><a href="../Provider/Gmw/"><img
        ...
        <div class="row rgpame d-flex justify-content-center lazyload">
            ...
            <div class="gameplay hover10">
                ...
                <?php
                    } else if (strtotime($createdAt) < strtotime('2020-01-01') && strtotime($updatedAt) > strtotime('2020-01-01')) {
                        // Jika created_at dan updated_at lebih dari tahun 2020
                    ?>
                <img class="lazyload" data-src="/tr3xd1ath/storage/<?= $row['gambar'] ?>" alt="<?= $row['nama'] ?>"
                    data-toggle="modal" data-target="#<?php echo $i; ?>">
                <?php
                    ...
                    ?>
                <img class="lazyload" data-src="/tr3xd1ath/storage/imgrtp/PP/<?= $row['gambar'] ?>"
